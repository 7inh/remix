      ...
      <CollapsibleTrigger className="w-full">
        <NavLink
          ...
          className={({ isActive }) =>
            ...
            } hover:bg-zinc-200 flex items-center text-gray-500 hover:text-gray-900 w-full p-0 leading-tight transition-all rounded-lg outline-none text-start hover:bg-blue-gray-50 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900`
          }
        >
          <div className="flex items-center w-full p-2.5 py-1.5 font-sans text-xl hover:text-blue-gray-900 group-[.selected]:text-black">
